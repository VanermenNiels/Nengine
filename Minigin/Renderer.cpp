...
void dae::Renderer::RenderTexture(const Texture2D& texture, float x, float y, SDL_Rect sourceRect) const
{
	SDL_FRect dst{};
	dst.x = x;
	dst.y = y;
	dst.w = static_cast<float>(sourceRect.w);
	dst.h = static_cast<float>(sourceRect.h);
